...
- Триггер/сжатие (LT) — захват объекта. После того как навелись на модель и она подсветилась, необходимо изменить положение ползунка(см. фото)
  ![Контроллер L](./public/image-1.png)
- Движение/поворот контроллера — перемещение объекта по полу. Необходимо нажать вблизи контроллера, чтобы появлись оси перемещения, после чего взять фокус в тот момент, когда на экране появятся три белых линии(оси) для управления контролерам во всех 3х осях
...
https://github.com/user-attachments/assets/ac05446d-ac03-49c3-80c7-12d0ba790825
